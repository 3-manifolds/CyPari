...
from autogen.pari.args import (PariArgumentGEN,
        PariArgument)
from autogen.pari.parser import (sage_src_pari,
        read_pari_desc, read_decl, parse_prototype)
from autogen.pari.doc import get_rest_doc
...
function_blacklist = {"O",  # O(p^e) needs special parser support
        ...
        "bernfrac",         # implemented in gen.pyx
        "bernreal"          # implemented in gen.pyx
        }
...
class PariFunctionGenerator(object):
    ...
    def can_handle_function(self, function, cname="", **kwds):
        ...
        EXAMPLES::
            ...
            sage: from autogen.pari.generator import PariFunctionGenerator
    ...
    def handle_pari_function(self, function, cname="", prototype="", help="", doc="", **kwds):
        ...
        if len(args) > 0 and isinstance(args[0], PariArgumentGEN):
            ...
            args, ret = parse_prototype(prototype, help, [PariArgument()])
            cargs = args[1:]
